...
class submitCell: UICollectionViewCell {
    ...
    @IBAction func submitClicked(sender: AnyObject)
    {
        ...
        Alamofire.request(.POST, "http://192.168.182.90:8000/processing_panel/set_model_size", parameters: ["user_id": "1069249093136307","bust_size": bust,"height_size": height,"complexion": complexion,"waist_size": waist, "hip_size": hip])
            .validate()
