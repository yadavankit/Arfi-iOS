...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/ImageCropView/ImageCropView.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/PaperCollectionView/PaperCollectionView.framework"
  install_framework "$BUILT_PRODUCTS_DIR/Petal/Petal.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/Track/Track.framework"
